...
Original file is located at
    https://colab.research.google.com/drive/1ZurFXgYQ7bzRjioFu_Pdkgz56hzJyle8
"""
...
h3, p, span, div, .stTextInput > div > div > input {{
    color: #333333 !important; /* Cinza escuro para melhor legibilidade */
...
h2 {{
    color: #00BFFF !important; /* Azul claro */
    font-weight: bold !important;
}}
...
.stTextInput > div > div > input {{
    ...
    color: #000000 !important; /* Cor do texto no input (preto) */
...
if not st.session_state.iniciado:
    ...
    st.markdown("<p style='font-size: 18px;'><b>Prepare-se para exercitar suas tabuadas de 2 a 9!</b></p>", unsafe_allow_html=True)
    st.markdown(f"<p style='font-size: 18px;'><b>Você terá {TOTAL_PERGUNTAS} perguntas aleatórias e únicas para resolver de uma vez.</b></p>", unsafe_allow_html=True)
    st.markdown("<p style='font-size: 18px;'><b>Ao final, poderá verificar seu percentual de acertos.</b></p>", unsafe_allow_html=True)
    ...
    if st.session_state.mostrar_resultados_finais:
        ...
        st.markdown(f"<p style='font-size: 18px;'>Acertos: <b>{st.session_state.acertos}</b></p>", unsafe_allow_html=True)
        st.markdown(f"<p style='font-size: 18px;'>Erros: <b>{st.session_state.erros}</b></p>", unsafe_allow_html=True)

        percentual = (st.session_state.acertos / TOTAL_PERGUNTAS) * 100 if TOTAL_PERGUNTAS > 0 else 0
        st.markdown(f"<p style='font-size: 18px;'>Percentual de Acertos: <b>{percentual:.2f}%</b></p>", unsafe_allow_html=True)
    ...
    st.markdown("<p style='font-size: 16px;'><b>Atenção:</b> Não deixe campos em branco e digite apenas números. Digitar algo diferente será contado como erro.</p>", unsafe_allow_html=True)
