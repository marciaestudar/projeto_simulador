...
Original file is located at
    https://colab.research.google.com/drive/10Tn6MULT3AW6dVyK-MkSWEiDEhze9LvI
"""
...
TOTAL_PERGUNTAS = 21 # Ajustado para 21 perguntas
NUM_COLUMNS = 3
...
def gerar_lista_perguntas():
    """Gera uma lista de 21 perguntas de tabuada aleatórias e únicas.""" # Atualizado no docstring
    perguntas = []
...
BACKGROUND_IMAGE_RAW_URL = "https://raw.githubusercontent.com/marciaestudar/projeto_simulador/main/imagem_criancas2.jpeg" # Nova imagem de fundo
...
/* --- ESTILO PARA O BOTÃO "VERIFICAR MINHAS RESPOSTAS" --- */
...
/* --- ESTILO PARA OS BOTÕES "INICIAR MARATONA" e "REINICIAR MARATONA" --- */
...
[data-testid="stButton"] > button[aria-label="Começar um novo desafio"] {{
    background-color: #008CBA; /* Azul Ciano Escuro */
    color: white;
    border-radius: 8px;
    padding: 10px 20px;
    font-size: 18px;
...
[data-testid="stButton"] > button[aria-label="Começar um novo desafio"]:hover {{
    background-color: #007B8E; /* Azul um pouco mais escuro no hover */
...
if not st.session_state.iniciado:
    ...
    st.divider()
    # Nome da autora no mesmo tamanho das frases - Corrigido para "Criação" e tamanho
