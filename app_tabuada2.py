...
Original file is located at
    https://colab.research.google.com/drive/1LsjyOZr4Cc0QBdut4U5FZt3T5pWw__6U
"""
...
def proxima_pergunta():
    ...
    st.session_state.mostrar_resultado_pergunta = False
    st.session_state.input_resposta_desabilitado = False
    # Limpa os placeholders para a nova pergunta
...
def verificar_resposta(resposta_usuario_input):
    ...
    st.session_state.input_resposta_desabilitado = True # Desabilita o input e botão "Responder"
...
if not st.session_state.iniciado:
    ...
    with col2:
        ...
        if st.button("Responder", disabled=st.session_state.input_resposta_desabilitado):
            # st.number_input retorna 0 se não há nada digitado. Precisamos verificar se o usuário realmente digitou algo.
            # Convertemos para string e verificamos se não é vazia, ou se é 0 e o usuario digitou 0 (explicitamente)
            # Para simplificar, vamos verificar se é None (que pode acontecer se o campo nunca foi focado/preenchido)
            # ou se é 0 (e o 0 é uma resposta válida para a tabuada de 0, que não estamos usando, mas é bom ter em mente)

            # Aqui, vamos considerar que se o usuário clicou em responder, ele quis submeter o valor atual do input.
            # A validação de "digitou ou não" está mais abaixo em verificar_resposta
