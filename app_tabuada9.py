...
Original file is located at
    https://colab.research.google.com/drive/1V1HtYR9u-CkO_CJhAPh-ctGo0atnCv7X
"""
...
# Agora este bloco vem DEPOIS do st.set_page_config()
...
# Substitua pela sua URL preferida ou use a opção local abaixo:

# Para usar uma imagem local no seu projeto (descomente este bloco e comente a linha BACKGROUND_IMAGE_URL acima):
# def get_base64_of_bin_file(bin_file):
#     with open(bin_file, 'rb') as f:
#         data = f.read()
#     return base64.b64encode(data).decode()
# img_base64 = get_base64_of_bin_file('fundo_divertido.png') # Nome do seu arquivo de imagem local
# page_bg_img_css = f'''
# <style>
...
# --- Funções Auxiliares (podem ficar depois do st.set_page_config e da injeção de CSS) ---
