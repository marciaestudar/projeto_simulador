...
Original file is located at
    https://colab.research.google.com/drive/1lwebu57BQMUmghyheSq9jzgLBvUYkdvC
"""
...
st.markdown("<h2 style='text-align: center; color: #0000FF;'>Vamos aprender e brincar muito!</h2>", unsafe_allow_html=True)
...
if not st.session_state.iniciado:
    ...
    st.write("")
    # Removido o help do botão para evitar a segunda frase
    ...
    if st.session_state.mostrar_resultados_finais:
        ...
        with col_res2:
            ...
            # A frase "Para finalizar o aplicativo..." foi movida para o botão Final.
            # st.write("Para finalizar o aplicativo, basta fechar esta aba do navegador.") # Removido
    ...
    st.markdown("<p style='font-size: 20px; color: red;'><b>Atenção:</b> Não deixe campos em branco e digite apenas números. Digitar algo diferente será contado como erro.</p>", unsafe_allow_html=True)
