# -*- coding: utf-8 -*-
"""app_tabuada11b.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lK_9_wVCmruDdDeaYFKxps2FpLJSjkf8
"""
...
TOTAL_PERGUNTAS = 30 # Mantido o valor 30 do seu código
NUM_COLUMNS = 3
...
BACKGROUND_IMAGE_RAW_URL = "https://raw.githubusercontent.com/marciaestudar/projeto_simulador/main/imagem_criancas3.jpeg"
...
page_bg_img_css = f"""
        ...
        [data-testid="stButton"] > button[aria-label="Enviar todas as respostas para correção"] {{
        ...
        [data-testid="stButton"] > button[aria-label="Enviar todas as respostas para correção"]:hover {{
        ...
        [data-testid="stButton"] > button[aria-label="Finalizar o aplicativo"] {{
        ...
        [data-testid="stButton"] > button[aria-label="Finalizar o aplicativo"]:hover {{
            ...
            box_shadow: 4px 4px 10px rgba(0,0,0,0.4);
        }}
